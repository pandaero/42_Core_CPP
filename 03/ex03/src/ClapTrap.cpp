...
/*   Updated: 2023/02/16 10:50:09 by pandalaf         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// PUBLIC
//Default constructor
ClapTrap::ClapTrap(void): hitpoints(100), energypts(100), attackdmg(30)
{
...
ClapTrap::ClapTrap(std::string name): name(name), hitpoints(100), energypts(100), attackdmg(30)
{
